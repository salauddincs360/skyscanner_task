...
class RoundTripScreen extends StatefulWidget {
  const RoundTripScreen({Key? key}) : super(key: key);

  @override
  State<RoundTripScreen> createState() => RoundTripScreenState();
}

class RoundTripScreenState extends State<RoundTripScreen> {
  @override
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                height: 45,
                                padding: EdgeInsets.only(left: 15,right: 15),
                                margin: EdgeInsets.only(left: 8,right: 2,top: 4,bottom: 1),
                                decoration: BoxDecoration(
                                    color: Colors.white,
                                    borderRadius: BorderRadius.all(Radius.circular(8))
                                ),
                          ...
                          Expanded(
                            child: InkWell(
                              ...
                              child: Container(
                                height: 45,
                                padding: EdgeInsets.only(left: 15,right: 15),
                                margin: EdgeInsets.only(left: 2,right: 8,top: 4,bottom: 1),
                                decoration: BoxDecoration(
                                    color: Colors.white,
                                    borderRadius: BorderRadius.all(Radius.circular(8))
                                ),
                                child: Row(
                                  children: [
                                    FaIcon(FontAwesomeIcons.calendarDays,size: 18,),
                                    SizedBox(width: 15,),
                                    Text("${controller.return_date}",style: TextStyle(),)
                                  ],
                                ),
                              ),
                            ),
