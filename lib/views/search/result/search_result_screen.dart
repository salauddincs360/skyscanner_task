                     ...
                     Expanded(
                       child: InkWell(
                         ...
                         child: Column(
                           crossAxisAlignment: CrossAxisAlignment.start,
                           children: [
                             Text("${controller.departing_from}",maxLines: 1,overflow: TextOverflow.clip,),
             ...
             Expanded(
               child: Container(
                 ...
                 child: ListView(
                   ...
                   children: [
                     SizedBox(height: 20,),
                     Text("Flights to ${controller.flying_to}",style: TextStyle(
                         fontSize: 18
                     ),),
                     SizedBox(height: 10,),
                     SingleChildScrollView(
                       ...
                       child: Row(
                         children: [
                           ...Iterable.generate(SearchData().filters.length).map((e) => InkWell(
                             onTap: (){
                            controller.ChangeResultFilter(SearchData().filters[e]);
                             },
                             child: Container(
                               ...
                               decoration: BoxDecoration(
                                   ...
                                   color: SearchData().filters[e]==controller.selected_filter?ColorsHelper().appbar_color:Colors.white
                               ),
                               child: Center(
                                 child: Text("${SearchData().filters[e]}",style: TextStyle(color: SearchData().filters[e]==controller.selected_filter?Colors.white:Colors.black),),
                               ),
                             ),
                           ))
                         ],
                     ...
                     SingleChildScrollView(
                       child: Column(
                         children: [
                           ...Iterable.generate(controller.total_result).map((e) => Container(
                             height: 140,
                             child: Card(
